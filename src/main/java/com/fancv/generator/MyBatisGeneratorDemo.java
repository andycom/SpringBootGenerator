...
import static com.fancv.generator.ProjectConstant.*;
...
public class MyBatisGeneratorDemo {
    ...
    private static final String AUTHOR = "@hamish";//@author
    private static final String DATE = new SimpleDateFormat("yyyy/MM/dd").format(new Date());//@date


    public static void main(String[] args) {
        genCode("wj_authentication_info");//测试表 企业认证
    }
    ...
    public static void genModelAndMapper(String tableName, String modelName) {
        ...
        File configFile = new File(MyBatisGeneratorDemo.class.getResource(genCfg).getFile());
        ...
        if (StringUtils.isEmpty(modelName = tableNameConvertUpperCamel(tableName))) {
